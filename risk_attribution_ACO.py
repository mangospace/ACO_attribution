...
#    image1.show()
    ...
    st.image('https://raw.githubusercontent.com/mangospace/ACO_attribution/main/Screenshot%202022-09-27%20204902.jpg', caption='Attribution and other program features of different Medicare ACOs(Norris, 2020)')
