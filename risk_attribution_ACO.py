...
#    image1.show()
    ...
    st.write("While payors could be satisfied with 80-85% attribution, this might not be satisfactory to PCPs/risk taking entities for whom 15-20% 'misidentification' can result in significant financial risk.")
