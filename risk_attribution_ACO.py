...
#    image1.show()
    ...
    st.write("Many Medicaid beneficiaries access primary care through the emergency room (ER), urgent care, or perhaps do not use primary care at all. Because of lack of claims experience, it can be difficult to appropriately attribute a Medicaid beneficiary to a provider who is realistically able to manage the patient’s care. This can be overcome to the extent if hospitals/Urgent Care/Emergency Department (and/or their clinicians) can be part of ACOs/IPAs. Below are some tethodologies used in attribution in Medicaid Section 1115 programs.")
    st.image('https://raw.githubusercontent.com/mangospace/ACO_attribution/main/Screenshot%202022-09-29%20100857_1.jpg')
    st.image('https://raw.githubusercontent.com/mangospace/ACO_attribution/main/Screenshot%202022-09-29%20100857_2.jpg', caption='Attribution methods in Section 1115 Medicaid)')
...
with ref_container:
    ...
    st.write('Au M, Appold C, Stringer R, Balke P Attribution in DSRIP Demonstration Programs: A Spotlight on New Jersey and New York
