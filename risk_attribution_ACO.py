...
#    image1.show()
    ...
    st.write("Many Medicaid beneficiaries access primary care through the emergency room (ER), urgent care, or perhaps do not use primary care at all. Because of lack of claims experience, it can be difficult to appropriately attribute a Medicaid beneficiary to a provider who is realistically able to manage the patient’s care. This can be overcome to the extent if hospitals/Urgent Care/Emergency Department (and/or their clinicians) can be part of ACOs/IPAs.")
