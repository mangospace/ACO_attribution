...
#    image1.show()
    ...
    st.image('https://raw.githubusercontent.com/mangospace/ACO_attribution/main/Screenshot%202022-09-25%20213505.jpg', caption='Incremental performance of patient attribution methodologies, BCBS - MA, unknown Line of Business (Health Care Payment Learning and Action Network (HCP-LAN)')
